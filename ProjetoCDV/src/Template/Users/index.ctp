                ...
                <tr>
                    ...
                    <td>
                        <span class="d-none d-md-block">
                            ...
                            <?= $this->Form->postLink(__('Apagar'), ['controller' => 'users', 'action' => 'delete', $user->id], ['class' =>'btn btn-outline-danger btn-sm', 'confirm' => __('Tem certeza que deseja excluir # {0}?', $user->id)]) ?>                      
                        </span>
                        <div class="dropdown d-block d-md-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                ...
                                <?= $this->Form->postLink(__('Apagar'), ['controller' => 'users', 'action' => 'delete', $user->id], ['class' =>'dropdown-item', 'confirm' => __('Tem certeza que deseja excluir # {0}?', $user->id)]) ?>
                            </div>
                        </div>
                    </td>
                </tr>
